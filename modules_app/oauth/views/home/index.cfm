<cfoutput>
	<div class="mx-4 xl:mx-64 bg-white shadow sm:rounded-lg">
		<div class="px-4 py-5 sm:p-6">
			<h2 class="text-2xl mb-6 font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">OAuth</h2>
			<div class="sm:flex sm:items-start sm:justify-between">
				<div>
					<h3 class="text-lg leading-6 font-medium text-gray-900">Secured Page</h3>
					<div class="mt-2 max-w-xl text-sm text-gray-500">
						<p>Welcome to the secured page for the GitHub OAuth module.</p>
					</div>
				</div>
				<div class="mt-5 sm:mt-0 sm:ml-6 sm:flex-shrink-0 sm:flex sm:items-center">
					<form method="POST" action="#event.buildLink( "oauth.logout" )#">
